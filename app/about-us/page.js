        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-3 col-md-4 col-xs-12 col-12 d-flex align-items-center">
              <div className='colorhomecollection'>
              <Homecollection />
              </div>
            </div>
          </div>
        </div>
          <Dots className="hsection position-absolute svgwidth opacity-10 endminus top-0 left-inherit "/>
        ...
        <div className="container">
          <div className="web-container">
            <div className="row">
              ...
              <div className="col-lg-8 m-auto col-12 float-start mt-3">
                <p><strong>Laboratory aims to achieve the objectives by :</strong></p>
                <ul className='p-0 m-0 quality'>
